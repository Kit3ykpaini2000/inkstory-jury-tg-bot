...
QUEUE_MODE: str        = _str("QUEUE_MODE", "balanced")   # open | balanced
...
def validate() -> None:
    ...
    if QUEUE_MODE not in ("open", "balanced"):
        raise ValueError(f"QUEUE_MODE должен быть 'open' или 'balanced', получили: '{QUEUE_MODE}'")
