...
QUEUE_MODE: str        = _str("QUEUE_MODE", "distributed")   # open | distributed
...
def validate() -> None:
    ...
    if QUEUE_MODE not in ("open", "distributed"):
        raise ValueError(f"QUEUE_MODE должен быть 'open' или 'distributed', получили: '{QUEUE_MODE}'")
